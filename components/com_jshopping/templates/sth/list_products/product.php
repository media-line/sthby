...
<div class="uk-product-teaser productitem_<?php print $product->product_id?> uk-position-absolute uk-text-center">
    ...
    <div class = "uk-product-teaser-info uk-inline-block">
        ...
        <?php if ($product->_display_price){?>
            <div class = "uk-product-teaser-price uk-text-large">
        ...
        */?>
        ...
        <div class="buttons">
            ...
            <a class="uk-button uk-button-small uk-margin-large-top" href="<?php print $product->product_link?>">
