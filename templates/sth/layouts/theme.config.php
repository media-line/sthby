...
unset($doc);
$this['asset']->addFile('css', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/themes/smoothness/jquery-ui.css');
$this['asset']->addFile('js', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js');
...
$this['asset']->addFile('js', 'js:slider-circle.js');
$this['asset']->addFile('js', 'js:theme.js');
$head[] = sprintf('<meta name="viewport" content="width=1300" />');
