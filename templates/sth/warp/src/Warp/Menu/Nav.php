    ...
    public function process($module, $element)
    {
        ...
        if ($module->nav_settings['accordion']) {
            ...
            foreach($ul->find("ul.level2") as $list) {
				...
				$list->attr('data-uk-nav', is_string($module->nav_settings['accordion']) ? $module->nav_settings['accordion']:'{}');
            }
			
			foreach($ul->find("ul.level3") as $list) {
