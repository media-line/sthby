...
<div class="uk-grid">
	<div class="uk-width-1-1">
		<div class="uk-panel uk-panel-header">
			...
			<div class="tm-title uk-h1 uk-text-bold uk-margin-top uk-margin-large-bottom"><?php echo $this->escape($this->params->get('page_heading')); ?></div>
			<?php endif; ?>
			...
			<div class="uk-h1 uk-text-bold uk-margin-small-top uk-margin-large-bottom"><?php echo $this->category->title;?></div>
			<?php endif; ?>
...
if ($count = count($columns)) {
	$articles  .= '<div class="uk-grid uk-grid-large" data-uk-grid-match data-uk-grid-margin>';
	for ($i = 0; $i < $count; $i++) {
		$articles .= '<div class="uk-width-medium-1-'.$num_columns.'">'.$columns[$i].'</div>';
	}
	$articles  .= '</div>';
}
