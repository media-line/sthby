...
<div class="uk-md-phones uk-md-phones-<?php echo $moduleclass_sfx ?> uk-phones-sidebar" >
	<?php if ($textBefore != ''): ?>
	...
	<?php endif;?>
		<?php for ($i = 0; $i < $phoneCount; $i++):?>
			<a class="uk-md-phone-row" href="tel:<?php echo $phoneList->country_code[$i].$phoneList->operator_code[$i].$phoneList->phone_number[$i];?>">
				...
				<span><?php echo $phoneList->country_code[$i];?></span>
				<span><?php echo $phoneList->operator_code[$i];?></span>
				<span class="uk-phone-number uk-text-bold"><?php echo $phoneList->phone_number[$i];?></span>
				<span class="uk-note uk-text-large"><?php echo $phoneList->note[$i];?></span>
			</a>
		<?php endfor;?>
	<?php if ($textAfter != ''): ?>
